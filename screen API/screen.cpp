...
int setScreenBrightnessSupported() {
    ...
    if (bl->name == PA06)
        return 0;
#endif
#ifdef NRF52_SERIES // yeah techincaly this OS is for STM32F4xx so i should minmize codel ike this (really the compiler will do these #ifdef things becuase they are preprocseser things)
...
// noramll //% comments would be here but well... thers no TS side , nor pxt.
