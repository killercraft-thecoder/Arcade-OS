...
namespace DigitalInOutPinMethods
{
    ...
    {
        PullMode m = pull == PinPullMode::PullDown ? PullMode::Down : pull == PinPullMode::PullUp ? PullMode::Up
                                                                                                  : PullMode::None;
        PINOP(setPull(m));
    }
...
namespace pxt
{
    ...
    {
        // I have a NOp train you have a Nop train eveeryone... Wait the NOP parts commented out... Nobody has a NOP train.
        // for (int i = 0; i < 10; ++i)
        //    asm volatile("nop");
    }
