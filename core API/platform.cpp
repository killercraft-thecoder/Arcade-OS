...
// Uhh , wha tdoes it mean by Timer? Really what Timers are Defined?
...
// Compiler will reduce to blank , becuase this striaght up returns.
inline void platformSendSerial(const char *data, int len) {
    return;
}
