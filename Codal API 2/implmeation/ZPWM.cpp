...
void ZPWM::enable()
{
    ...
    case TIM_CHANNEL_1:
        ...
        break;
    case TIM_CHANNEL_2:
        __HAL_TIM_ENABLE_DMA(&tim, TIM_DMA_CC2);
        break;
    case TIM_CHANNEL_3:
        __HAL_TIM_ENABLE_DMA(&tim, TIM_DMA_CC3);
        break;
    case TIM_CHANNEL_4:
        __HAL_TIM_ENABLE_DMA(&tim, TIM_DMA_CC4);
        break;
    }
...
void ZPWM::disable()
{
    ...
    case TIM_CHANNEL_1:
        ...
        break;
    case TIM_CHANNEL_2:
        __HAL_TIM_DISABLE_DMA(&tim, TIM_DMA_CC2);
        break;
    case TIM_CHANNEL_3:
        __HAL_TIM_DISABLE_DMA(&tim, TIM_DMA_CC3);
        break;
    case TIM_CHANNEL_4:
